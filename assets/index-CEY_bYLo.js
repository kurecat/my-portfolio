...
`,Za=[{icon:(0,P.jsx)(_r,{size:26}),title:`Understand`,subtitle:`요구사항 이해`,description:`먼저 만들 기능의 목적과 사용자가 어떤 흐름으로 화면을 이용할지 정리합니다. 필요한 데이터와 API 흐름도 함께 확인합니다.`},{icon:(0,P.jsx)(Tr,{size:26}),title:`Structure`,subtitle:`컴포넌트 구조 설계`,description:`화면을 역할별 컴포넌트로 나누고, 재사용 가능한 UI와 상태가 필요한 영역을 구분해 구조를 잡습니다.`},{icon:(0,P.jsx)(Mr,{size:26}),title:`Build`,subtitle:`UI 구현`,description:`React와 JavaScript를 기반으로 화면을 구현하고, 반응형 레이아웃과 사용자 인터랙션을 고려해 완성도를 높입니다.`},{icon:(0,P.jsx)(Cr,{size:26}),title:`Connect`,subtitle:`API 연동`,description:`Axios를 활용해 백엔드 API와 데이터를 연결하고, 로딩·에러·빈 데이터 상황을 화면 흐름 안에서 처리합니다.`},{icon:(0,P.jsx)(vr,{size:26}),title:`Improve`,subtitle:`검토와 개선`,description:`동작 여부만 확인하지 않고, 코드 가독성·컴포넌트 분리·사용자 흐름을 다시 점검하며 개선합니다.`}];function Qa(){return(0,P.jsx)($a,{id:`process`,children:(0,P.jsxs)(eo,{children:[(0,P.jsxs)(to,{children:[(0,P.jsx)(no,{children:`Development Process`}),(0,P.jsxs)(ro,{children:[`화면을 구현하기 전,`,(0,P.jsx)(`br`,{}),`흐름과 구조를 먼저 정리합니다`]}),(0,P.jsx)(io,{children:`프로젝트를 진행할 때는 바로 코드를 작성하기보다 요구사항, 데이터 흐름, 컴포넌트 구조를 먼저 정리하려고 합니다. 이 과정을 통해 유지보수하기 쉬운 화면을 만드는 것을 목표로 합니다.`})]}),(0,P.jsx)(ao,{children:Za.map((e,t)=>(0,P.jsxs)(oo,{children:[(0,P.jsx)(so,{children:String(t+1).padStart(2,`0`)}),(0,P.jsx)(co,{children:e.icon}),(0,P.jsxs)(lo,{children:[(0,P.jsx)(uo,{children:e.title}),(0,P.jsx)(fo,{children:e.subtitle}),(0,P.jsx)(po,{children:e.description})]})]},e.title))})]})})}var $a=M.section`
  background: ${N.background};
  border-top: 1px solid ${N.border};
`,eo=M.div`
  max-width: 1280px;
...
`,po=M.p`
  ...
  line-height: 1.75;
  word-break: keep-all;
`,mo=[{icon:(0,P.jsx)(Mr,{size:26}),category:`Frontend`,description:`사용자 화면을 구성하고 API 데이터를 연결하는 프론트엔드 구현 경험이 있습니다.`,skills:[`React`,`JavaScript`,`HTML5`,`CSS3`,`Axios`,`Responsive UI`]},{icon:(0,P.jsx)(hr,{size:26}),category:`Backend / API`,description:`Spring Boot 기반 API를 만들고 프론트엔드와 연결하며 서비스 흐름을 이해했습니다.`,skills:[`Java`,`Spring Boot`,`REST API`,`C#`,`Server Logic`]},{icon:(0,P.jsx)(Ar,{size:26}),category:`Database`,description:`데이터 모델링과 SQL 작성 경험을 바탕으로 데이터 흐름을 함께 고려합니다.`,skills:[`OracleDB`,`MySQL`,`SQL`,`PL/SQL`,`Data Modeling`]},{icon:(0,P.jsx)(pr,{size:26}),category:`Tools & Collaboration`,description:`팀 프로젝트에서 버전 관리, 문서 정리, 화면 설계 도구를 활용했습니다.`,skills:[`Git`,`GitHub`,`Figma`,`Notion`,`Tableau`]}];function z(){return(0,P.jsx)(B,{id:`skills`,children:(0,P.jsxs)(ho,{children:[(0,P.jsxs)(go,{children:[(0,P.jsx)(_o,{children:`Skills & Tools`}),(0,P.jsxs)(vo,{children:[`기술을 단순히 나열하기보다`,(0,P.jsx)(`br`,{}),`어떻게 활용했는지 보여주고자 합니다`]}),(0,P.jsx)(yo,{children:`프론트엔드 구현을 중심으로 백엔드 API, 데이터베이스, 협업 도구까지 함께 경험하며 서비스가 동작하는 전체 흐름을 이해하려고 노력했습니다.`})]}),(0,P.jsx)(bo,{children:mo.map(e=>(0,P.jsxs)(xo,{children:[(0,P.jsxs)(So,{children:[(0,P.jsx)(V,{children:e.icon}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(Co,{children:e.category}),(0,P.jsx)(wo,{children:e.description})]})]}),(0,P.jsx)(To,{children:e.skills.map(e=>(0,P.jsxs)(Eo,{children:[(0,P.jsx)(Do,{children:(0,P.jsx)(Nr,{size:16})}),e]},e))})]},e.category))})]})})}var B=M.section`
  background: ${N.white};
  border-top: 1px solid ${N.border};
`,ho=M.div`
  max-width: 1280px;
...
`,Do=M.span`
  color: ${N.accent};
  display: inline-flex;
`,Oo=[{period:`2026.02 - 2026.04`,title:`AI 기반 빅데이터 분석 및 예측·자동화 서비스 구축`,organization:`휴먼교육센터`,icon:(0,P.jsx)(jr,{size:26}),summary:`데이터 수집, 처리, AI 모델링, 시각화, 자동화 서비스 구축 흐름을 학습했습니다.`,points:[`TensorFlow 기반 머신러닝/딥러닝 모델 학습 경험`,`스마트팜 이상 징후 자율 대응 자동화 시스템 프로젝트 수행`,`React와 Spring Boot를 연동한 모니터링 및 제어 화면 구현`,`Docker, Kubernetes 등 클라우드·인프라 기본 개념 학습`],tags:[`AI`,`TensorFlow`,`React`,`Spring Boot`,`Docker`,`Kubernetes`]},{period:`2025.08 - 2026.02`,title:`JAVA 활용 스마트 팩토리 MES 웹솔루션`,organization:`휴먼교육센터`,icon:(0,P.jsx)(Ar,{size:26}),summary:`MES 도메인을 기반으로 데이터베이스 설계부터 웹 서버 구현, 화면 구성까지 전체 흐름을 경험했습니다.`,points:[`Oracle DB 기반 테이블 설계, SQL/PLSQL 작성`,`Java와 Spring Boot 기반 웹 서버 및 REST API 구현 경험`,`React 기반 컴포넌트 UI 구현 및 비동기 데이터 연동`,`생산 관리, 자재 관리, 공정 관리 등 MES 기본 흐름 이해`],tags:[`Java`,`React`,`Spring Boot`,`OracleDB`,`PL/SQL`,`MES`]},{period:`2023.04 - 2025.01`,title:`공군 병장 만기전역`,organization:`Military Service`,icon:(0,P.jsx)(mr,{size:26}),summary:`규칙적인 생활과 책임감을 바탕으로 맡은 일을 끝까지 수행하는 태도를 길렀습니다.`,points:[`시간 약속과 맡은 역할을 지키는 책임감 강화`,`조직 안에서 협업하고 소통하는 경험 축적`,`정해진 절차와 기준을 지키며 업무를 수행하는 습관 형성`],tags:[`Responsibility`,`Teamwork`,`Discipline`]},{period:`2019.03 - 2023.02`,title:`스마트미디어 전공심화 졸업`,organization:`백석문화대학교`,icon:(0,P.jsx)(Fr,{size:26}),summary:`스마트미디어 전공을 통해 웹, 미디어, 소프트웨어 개발의 기초를 학습했습니다.`,points:[`스마트미디어 전공심화 과정 졸업`,`프로그래밍과 웹 기반 서비스 구현에 대한 기본기 학습`,`팀 프로젝트와 발표를 통한 협업 경험 축적`],tags:[`Smart Media`,`Web`,`Team Project`]}],ko=[{icon:(0,P.jsx)(fr,{size:22}),title:`팀장 경험`,text:`교육 과정 팀 프로젝트에서 역할을 나누고 전체 흐름을 관리하며 팀원들이 편하게 개발할 수 있도록 조율했습니다.`},{icon:(0,P.jsx)(Ar,{size:22}),title:`전체 흐름 이해`,text:`프론트엔드와 백엔드를 함께 다루며 화면, API, 데이터베이스가 연결되는 구조를 경험했습니다.`}];function Ao(){return(0,P.jsx)(jo,{id:`experience`,children:(0,P.jsxs)(Mo,{children:[(0,P.jsxs)(No,{children:[(0,P.jsx)(Po,{children:`Experience & Education`}),(0,P.jsxs)(Fo,{children:[`교육과 프로젝트를 통해`,(0,P.jsx)(`br`,{}),`서비스 전체 흐름을 경험했습니다`]}),(0,P.jsx)(Io,{children:`신입 개발자로서 실무 경력은 아직 많지 않지만, 교육 과정과 팀 프로젝트를 통해 프론트엔드, 백엔드, 데이터베이스가 연결되는 흐름을 꾸준히 경험해왔습니다.`})]}),(0,P.jsxs)(Lo,{children:[(0,P.jsx)(Ro,{children:Oo.map(e=>(0,P.jsxs)(zo,{children:[(0,P.jsx)(Bo,{children:e.icon}),(0,P.jsxs)(Vo,{children:[(0,P.jsxs)(Ho,{children:[(0,P.jsx)(Uo,{children:e.period}),(0,P.jsx)(Wo,{children:e.organization})]}),(0,P.jsx)(Go,{children:e.title}),(0,P.jsx)(Ko,{children:e.summary}),(0,P.jsx)(qo,{children:e.points.map(e=>(0,P.jsx)(Jo,{children:e},e))}),(0,P.jsx)(Yo,{children:e.tags.map(e=>(0,P.jsx)(Xo,{children:e},e))})]})]},`${e.period}-${e.title}`))}),(0,P.jsxs)(Zo,{children:[(0,P.jsx)(Qo,{children:`Working Style`}),(0,P.jsx)($o,{children:`꼼꼼하게 구조를 먼저 정리하고, 문제가 생길 수 있는 부분을 미리 생각하는 편입니다. 다만 일정 안에서 완성도를 맞추기 위해 우선순위를 정하며 개선해가고 있습니다.`}),(0,P.jsx)(es,{children:ko.map(e=>(0,P.jsxs)(ts,{children:[(0,P.jsx)(ns,{children:e.icon}),(0,P.jsxs)(`div`,{children:[(0,P.jsx)(rs,{children:e.title}),(0,P.jsx)(is,{children:e.text})]})]},e.title))})]})]})]})})}var jo=M.section`
  background: ${N.background};
  border-top: 1px solid ${N.border};
`,Mo=M.div`
  max-width: 1280px;
...
`,Ps=M.div`
  ...
  padding: 44px;
  border-radius: 36px;
  border: 1px solid ${H.panelBorder};
  background:
    linear-gradient(
      90deg,
...
`,cc=M.p`
  margin: 14px 0 0;
  color: ${({$isError:e})=>e?H.error:H.success};
  font-size: 14px;
  font-weight: 800;
  line-height: 1.6;
`;function lc(){return(0,P.jsxs)(P.Fragment,{children:[(0,P.jsx)(Gn,{}),(0,P.jsx)(Br,{}),(0,P.jsx)(Ai,{}),(0,P.jsx)(Wi,{}),(0,P.jsx)(sa,{}),(0,P.jsx)(Qa,{}),(0,P.jsx)(z,{}),(0,P.jsx)(Ao,{}),(0,P.jsx)(js,{})]})}(0,g.createRoot)(document.getElementById(`root`)).render((0,P.jsx)(lc,{}));